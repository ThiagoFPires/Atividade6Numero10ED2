class Triangulo {
    ...
    // função que determina o tipo do triângulo (Equilátero, Isósceles, Escaleno)
    ...
    // função que verifica se o triângulo é equilátero
    public String verificarEquilatero() {
